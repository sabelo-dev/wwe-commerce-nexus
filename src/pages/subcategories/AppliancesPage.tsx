  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="wwe-container py-8">
        ...
        {/* Page Header */}
        <div className="mb-8 relative rounded-lg overflow-hidden bg-gradient-to-r from-gray-700 to-gray-900">
          <div className="relative z-10 p-6 md:p-10">
            <h1 className="text-2xl md:text-4xl font-bold text-white mb-2">
              Home Appliances
            </h1>
            <p className="text-white/80 max-w-xl">
              Modern appliances to make your life easier. From kitchen essentials to 
              home comfort solutions, find quality appliances for every need.
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <h2 className="text-xl font-semibold">
              Home Appliances
              <span className="text-gray-500 ml-2">({appliances.length})</span>
            </h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-white rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600 mb-4">
                There are currently no appliances available.
              </p>
              <Link to="/shop">
